const featureBottom = ({ title, des, img }) => {
  return (
    <div className="lg:h-[500px] md:grid-cols-2 md:h-[400px] relative w-full h-[600px] my-9 grid grid-cols-1">
      <div
        data-aos="fade-down"
        className="lg:h-[500px] md:h-[400px] w-full h-[250px] flex justify-center items-center py-3"
      >
        <img
          src={img}
          alt=""
      ...
      <div
        data-aos="fade-down"
        className="md:relative md:top-0 md:justify-center justify-center md:items-start md:h-full w-full h-[340px] items-center absolute top-[260px] flex flex-col px-10"
      >
